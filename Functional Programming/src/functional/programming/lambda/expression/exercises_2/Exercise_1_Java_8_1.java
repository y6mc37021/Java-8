...
public class Exercise_1_Java_8_1 {
	...
	public static void main(String[] args) {
		...
		printOnCondition(person, p->true, p->System.out.println(p));
		...
		printOnCondition(person, p->p.getLastName().startsWith("C"), p->System.out.println(p));
		System.out.println("Print First Name");
		printOnCondition(person, p->p.getLastName().startsWith("C"), p->System.out.println(p.getFirstName()));
		
		
	}		
	
	public static void printOnCondition(List<Person> person, Predicate<Person> predicate, Consumer<Person> consumer) {
